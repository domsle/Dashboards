...
raw <- read_sheet('https://docs.google.com/spreadsheets/d/1yZv9w9zRKwrGTaR-YzmAqMefw4wMlaXocejdxZaTs6w/pubhtml')
df <- raw %>% 
  select(-'Last Update', City = `Province/State`, Country = `Country/Region`) %>% 
