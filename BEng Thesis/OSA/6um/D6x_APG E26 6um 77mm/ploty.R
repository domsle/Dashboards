...
pows <- data %>% filter(x1 == 1572.6) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19, y20) %>% as_vector()
pows2 <- data %>% filter(x1 == 1589.1) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19, y20) %>% as_vector()
pows3 <- data %>% filter(x1 == 1580.2) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19, y20) %>% as_vector()


# Pierwszy pik

# CAPS to odległości między magnesami
caps <- c(seq(95, 35, -5), seq(30, 4, -4))
### Największy pik
...
pows <- data %>% filter(x1 == 1570.7) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19) %>% as_vector()
