...
pows <- data %>% filter(x1 == 1559.3) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19) %>% as_vector()

pows2 <- data %>% filter(x1 == 1567.5) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19) %>% as_vector()
