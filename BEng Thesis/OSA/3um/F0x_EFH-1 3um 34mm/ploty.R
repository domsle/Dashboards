...
pows <- data %>% filter(x1 == 1572.4) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9) %>% as_vector()

pows <- data %>% filter(x1 == 1560.9) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9) %>% as_vector()

pows <- data %>% filter(x1 == 1531.9) %>% select(y1, y2, y3, y4, y5, y6, y7, y8, y9) %>% as_vector()
